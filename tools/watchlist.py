...
代號與名稱皆已比對證交所／櫃買中心 API 驗證（2026-08-28；2026-09-14 新增 22 家時再驗一次）。
"""
...
SEGMENTS = [
    ...
    ("設備", "PCB／載板的濕製程、壓膜、烘烤與 AOI 檢測設備，替產能與良率守門，訂單能見度領先量產"),
    ("IC設計服務", "ASIC 設計服務與 IP，CSP 自研晶片的實作方，位在晶片設計與封測之間"),
    ("封測", "封裝測試，先進封裝（CoWoS、Cu-Cu）需求的直接受惠者"),
    ("記憶體", "DRAM／NAND／HBM 與控制 IC，AI 伺服器的另一個瓶頸，價格循環與 PCB 鏈不同步"),
    ("光通訊CPO", "光模組、光引擎與 FAU 等零組件，機櫃之間的資料搬運，CPO 是下一代整合方向"),
...
COMPANIES = {
    ...
    "3189": ("景碩", "載板"),
    "8021": ("尖點", "鑽針耗材"),
    # ── 設備（2026-09-14 新增，來源：ABF 供應鏈地圖與 CPO 價值鏈）
    "3485": ("敘豐", "設備"),
    "7795": ("長廣", "設備"),
    "6664": ("群翊", "設備"),
    "2467": ("志聖", "設備"),
    ...
    "6187": ("萬潤", "設備"),
    "2360": ("致茂", "設備"),
    # ── IC 設計服務（2026-09-14 新增，來源：Google TPU v10 晶片分工圖）
    "2454": ("聯發科", "IC設計服務"),
    "3661": ("世芯-KY", "IC設計服務"),
    "3443": ("創意", "IC設計服務"),
    "3711": ("日月光投控", "封測"),
    "6510": ("精測", "封測"),
    # ── 記憶體（2026-09-14 新增，來源：Nomura／TrendForce 記憶體供需報告）
    "2408": ("南亞科", "記憶體"),
    "2344": ("華邦電", "記憶體"),
    "6770": ("力積電", "記憶體"),
    "8299": ("群聯", "記憶體"),
    # ── 光通訊／CPO（2026-09-14 新增，來源：工商時報 CPO 價值鏈整理）
    "3363": ("上詮", "光通訊CPO"),
    "3163": ("波若威", "光通訊CPO"),
    "3450": ("聯鈞", "光通訊CPO"),
    "2308": ("台達電", "電源散熱"),
    ...
    "3017": ("奇鋐", "電源散熱"),
    "3665": ("貿聯-KY", "電源散熱"),
    # ── 電源散熱（2026-09-14 新增，來源：台股散熱投資地圖、投資產業地圖 #023、禾伸堂法說）
    "3653": ("健策", "電源散熱"),
    "2421": ("建準", "電源散熱"),
    "8996": ("高力", "電源散熱"),
    "3026": ("禾伸堂", "電源散熱"),
